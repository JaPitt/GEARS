% simulate_AP_model.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_AP_model(tout,theta)
% [...] = simulate_AP_model(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_AP_model(...)
%
% INPUTS:
% =======
...
function varargout = simulate_AP_model(varargin)
...
options_ami.id = transpose([0  0  0  0  0]);
...
sol = ami_AP_model(tout,theta(1:10),kappa(1:0),options_ami,plist,pbar,xscale,data);
if(options_ami.sensi==1)
end
