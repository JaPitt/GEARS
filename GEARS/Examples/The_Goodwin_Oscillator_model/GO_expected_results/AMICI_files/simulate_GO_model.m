% simulate_GO_model.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%
% USAGE:
% ======
% [...] = simulate_GO_model(tout,theta)
% [...] = simulate_GO_model(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_GO_model(...)
%
% INPUTS:
% =======
...
function varargout = simulate_GO_model(varargin)
...
sol = ami_GO_model(tout,theta(1:11),kappa(1:0),options_ami,plist,pbar,xscale,data);
if(options_ami.sensi==1)
end
