...
Fitting_data.(char(Fitting_exp_name)).Time_points = [1.0000;  4.8000; 8.6000; 12.4000; 16.2000; 20.0000]; % The time points for the experiment. (vector)

Fitting_data.(char(Fitting_exp_name)).Measurements = [1.4480; 1.0070; -1.3020; 1.6260; -1.3930; 1.8890]; % The measurements, should be of the size # time points vs # observables. (matrix)

Fitting_data.(char(Fitting_exp_name)).Standard_deviation = [0.2090; 0.1445; 0.1587; 0.1851; 0.2025; 0.2144]; % The standard deviation for the measurements, should be same size as the measurements. (matrix)
